...
def export_to_onnx(model: YOLO, model_path: Path, output_path: Path, imgsz: int, opset: int, nms: bool) -> Path:
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        default="none",
        help="Quantization strategy (experimental for this model). Use 'none' for fp32 export only.",
    )
    parser.add_argument(
        "--calibration-dir",
        type=Path,
