...
from scripts import vlm_viewer_audit as audit
...
def test_prompt_context_for_mobile_roi() -> None:
    context = audit.prompt_context_for("viewer-small-phone-viewer-mobile-roi.png")
    assert "ROI" in context
    assert "sidebar CLOSED" in context


def test_prompt_context_for_phone_viewer_context() -> None:
    context = audit.prompt_context_for("viewer-small-phone-viewer-context.png")
    assert "sidebar drawer CLOSED" in context
    assert "hamburger" in context
