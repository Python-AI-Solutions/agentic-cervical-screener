...
3. **Responsive & Accessible Header-First UX** – Map user stories to the breakpoints in `docs/project_overview.md §5`, including how ARIA/tap-target guarantees will be asserted.
