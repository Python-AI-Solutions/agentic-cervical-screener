...
**Tests**: Dual-Layer Evidence (Principle 2) requires pairing fast unit/integration coverage with Playwright journeys for every user-visible change. Only omit tests when the spec explicitly documents an approved exception.
...
- Include evidence + documentation updates so Principle 4 (documentation/data stewardship) stays satisfied before calling a story complete.
